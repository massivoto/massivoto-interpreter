...
**Last updated:** 2026-01-19
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/block-parser.spec.ts`
**Progress:** 3/3 (100%)
...
**Last updated:** 2026-01-19
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/program-parser.spec.ts`
**Progress:** 4/4 (100%)
...
```
packages/runtime/src/interpreter/parser/
